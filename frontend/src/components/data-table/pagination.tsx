    ...
    >
      ...
      <div className='flex items-center sm:space-x-6 lg:space-x-8'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          >
            <span className='sr-only'>跳至首页</span>
          ...
          {/* 页码按钮：key 在 JSX 外预计算（页码唯一；省略号同一页可出现两次，
              用起始/结束位置区分），避免在 key 表达式里用数组下标 */}
            ...
            return (
              <div key={key} className='flex items-center'>
                {pageNumber === '...' ? (
                  ...
                  >
                    <span className='sr-only'>跳至第 {pageNumber} 页</span>
                    {pageNumber}
                  </Button>
                )}
              </div>
          ...
          <Button
            ...
            disabled={!table.getCanNextPage()}
          >
            <span className='sr-only'>跳至末页</span>
